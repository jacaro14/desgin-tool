...
(function () {
    ...
    function getEditorIframe() {
        return document.querySelector('iframe.tox-edit-area__iframe') || document.querySelector('.tox-edit-area iframe');
    }
    ...
    function init() {
        loadScriptOnce('unah-bootstrap-js-parent', BOOTSTRAP_JS);
        enableSavedContentInteractions();

        const observer = new MutationObserver(function () {
            if (isEditingCanvasContent()) {
                if (!document.getElementById('unah-design-panel')) createPanel();
                applyEditorAssets();
    ...
    function createPanel() {
      ...
      <div class="unah-tab-content" id="unah-tab-content">${blocksView()}</div>
    `;
        ...
        panel.addEventListener('change', panelInput);
    ...
    function panelClick(e) {
        ...
        if (tabBtn) {
            ...
            setActiveTab(tab);
            if (tab === 'blocks') content.innerHTML = blocksView();
            if (tab === 'templates') content.innerHTML = templatesView();
            if (tab === 'styles') content.innerHTML = editView();
            return;
        }
        ...
        if (actionBtn) {
            selectedAction(actionBtn.dataset.action);
        }
    }
    ...
    function blocksView() {
      ...
      <div class="unah-tool-grid">
        <button class="unah-tool-tile" type="button" data-insert="accordion"><span>▾</span>Accordion</button>
        <button class="unah-tool-tile" type="button" data-insert="tabs"><span>▤</span>Tabs</button>
        <button class="unah-tool-tile" type="button" data-insert="hero"><span>H</span>Header</button>
        <button class="unah-tool-tile" type="button" data-insert="h2"><span>H2</span>Heading 2</button>
        <button class="unah-tool-tile" type="button" data-insert="h3"><span>H3</span>Heading 3</button>
        <button class="unah-tool-tile" type="button" data-insert="h4"><span>H4</span>Heading 4</button>
        <button class="unah-tool-tile" type="button" data-insert="callout"><span>!</span>Callout</button>
        <button class="unah-tool-tile" type="button" data-insert="button"><span>●</span>Button</button>
        <button class="unah-tool-tile" type="button" data-insert="divider"><span>—</span>Divider</button>
      </div>
    `;
    }
    ...
    function templatesView() {
      ...
      <h3>Templates</h3>
      <div class="unah-tool-grid">
        <button class="unah-tool-tile" type="button" data-insert="homepage"><span>⌂</span>Homepage</button>
        <button class="unah-tool-tile" type="button" data-insert="module-intro"><span>M</span>Module Intro</button>
      </div>
    `;
    }
    ...
    function editView() {
        if (!selectedBlock) {
            return '<h3>Edit Block</h3><p class="unah-muted">Seleccione un bloque dentro del editor.</p>';
        }
  ...
  <div class="accordion" id="${id}">
    <div class="accordion-item">
      <h2 class="accordion-header" id="${id}-heading-1">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#${id}-collapse-1" aria-expanded="true" aria-controls="${id}-collapse-1" data-unah-edit="title">Accordion Title</button>
      </h2>
      <div id="${id}-collapse-1" class="accordion-collapse collapse show" aria-labelledby="${id}-heading-1" data-bs-parent="#${id}">
        <div class="accordion-body" data-unah-edit="body">Accordion content goes here.</div>
      </div>
    </div>
  </div>
</div>`,
...
<div class="unah-editor-block unah-bs-block" data-unah-block="Tabs" data-unah-style="default">
  ...
  <ul class="nav nav-tabs" id="${id}" role="tablist">
    <li class="nav-item" role="presentation"><button class="nav-link active" id="${id}-tab-1" data-bs-toggle="tab" data-bs-target="#${id}-pane-1" type="button" role="tab" aria-controls="${id}-pane-1" aria-selected="true">Tab 1</button></li>
    <li class="nav-item" role="presentation"><button class="nav-link" id="${id}-tab-2" data-bs-toggle="tab" data-bs-target="#${id}-pane-2" type="button" role="tab" aria-controls="${id}-pane-2" aria-selected="false">Tab 2</button></li>
    <li class="nav-item" role="presentation"><button class="nav-link" id="${id}-tab-3" data-bs-toggle="tab" data-bs-target="#${id}-pane-3" type="button" role="tab" aria-controls="${id}-pane-3" aria-selected="false">Tab 3</button></li>
  </ul>
  <div class="tab-content border border-top-0 p-3">
    <div class="tab-pane fade show active" id="${id}-pane-1" role="tabpanel" aria-labelledby="${id}-tab-1" tabindex="0"><h3 data-unah-edit="title">Tab 1 Title</h3><p data-unah-edit="body">Tab 1 content goes here.</p></div>
    <div class="tab-pane fade" id="${id}-pane-2" role="tabpanel" aria-labelledby="${id}-tab-2" tabindex="0"><h3>Tab 2 Title</h3><p>Tab 2 content goes here.</p></div>
    <div class="tab-pane fade" id="${id}-pane-3" role="tabpanel" aria-labelledby="${id}-tab-3" tabindex="0"><h3>Tab 3 Title</h3><p>Tab 3 content goes here.</p></div>
  </div>
</div>`,
...
<div class="unah-editor-block unah-hero-block p-4 rounded-3 bg-light border" data-unah-block="Header" data-unah-style="default">
  ...
  <p class="lead mb-0" data-unah-edit="body">Short introductory text for this section.</p>
            ...
            h2: `<div class="unah-editor-block" data-unah-block="Heading 2" data-unah-style="default"><div class="unah-block-label">Heading 2</div><h2 class="border-bottom pb-2 text-primary" data-unah-edit="title">Heading 2</h2></div>`,
            h3: `<div class="unah-editor-block" data-unah-block="Heading 3" data-unah-style="default"><div class="unah-block-label">Heading 3</div><h3 class="text-primary" data-unah-edit="title">Heading 3</h3></div>`,
            h4: `<div class="unah-editor-block" data-unah-block="Heading 4" data-unah-style="default"><div class="unah-block-label">Heading 4</div><h4 class="fw-bold" data-unah-edit="title">Heading 4</h4></div>`,
...
<div class="unah-editor-block" data-unah-block="Button" data-unah-style="default">
  ...
  <p class="mb-0"><a class="btn btn-primary" href="#" data-unah-edit="title">Example Button</a></p>
</div>`,

            divider: `<div class="unah-editor-block" data-unah-block="Divider" data-unah-style="default"><div class="unah-block-label">Divider</div><hr class="border border-primary border-2 opacity-75"></div>`,
...
<div class="unah-editor-block" data-unah-block="Homepage" data-unah-style="default">
  ...
  <div class="row g-3">
    <div class="col-md-4"><div class="card h-100"><div class="card-body"><h3 class="card-title h5">Start Here</h3><p class="card-text">Review the course information.</p></div></div></div>
    <div class="col-md-4"><div class="card h-100"><div class="card-body"><h3 class="card-title h5">Modules</h3><p class="card-text">Access the weekly course content.</p></div></div></div>
    <div class="col-md-4"><div class="card h-100"><div class="card-body"><h3 class="card-title h5">Assessments</h3><p class="card-text">Review assignments and evaluations.</p></div></div></div>
  </div>
</div>`,
...
<div class="unah-editor-block" data-unah-block="Module Intro" data-unah-style="default">
  ...
  <div class="card border-primary mb-3">
    ...
    <div class="card-body"><p class="card-text" data-unah-edit="body">In this module, you will study the main concepts of the topic.</p></div>
  </div>
</div>`
        };
    ...
    function insertTemplate(type) {
        const html = template(type);
        const iframe = getEditorIframe();

        if (!html || !iframe || !iframe.contentDocument) {
    ...
    function applyEditorAssets() {
        ...
        if (!doc.getElementById('unah-bootstrap-css-editor')) {
            const bs = doc.createElement('link');
            bs.id = 'unah-bootstrap-css-editor';
            bs.rel = 'stylesheet';
            bs.href = BOOTSTRAP_CSS;
            doc.head.appendChild(bs);
        }

        if (!doc.getElementById('unah-editor-helper-css')) {
        ...
        .unah-editor-block:hover { outline: 3px solid rgba(13,110,253,.20) !important; }
        .unah-selected-block { outline: 3px solid #0d6efd !important; }
        .unah-block-label {
    ...
    function enableBlockSelection() {
        const doc = getEditorDoc();
        if (!doc || doc.body.dataset.unahBlockUiEnabled === 'true') return;

        doc.body.dataset.unahBlockUiEnabled = 'true';
        ...
        doc.addEventListener('click', function (event) {
            ...
            doc.querySelectorAll('.unah-selected-block').forEach(function (el) {
            ...
            const content = document.getElementById('unah-tab-content');
            if (content) content.innerHTML = editView();
        }, true);
    }
    ...
    function selectedAction(action) {
        ...
        if (action === 'duplicate') selectedBlock.insertAdjacentHTML('afterend', selectedBlock.outerHTML);
